<h2 class="text-center text-primary">CERTIFICACION DE APROBACION DEL EXAMEN DE CONDUCIR</h2>
<?php
    if($guardar==1){
?>
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <input id="medico" class="form-control" type="file" name="aprobacion" accept=".pdf">
        </div>
    </div>
    <div class="col-3">
